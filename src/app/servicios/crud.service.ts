...
import { Cliente, Iresponse, Producto, Comprar, UserLogin, IMoviePopular, IMovieDetails } from '../interfaces/myinterfaz'; 
...
//--proxy-config proxy.conf.json
  ...
  GetMoviePopular(): Observable<IMoviePopular> {
    ...
    return this.http.get<IMoviePopular>(this.apiURL + 'movie/popular?api_key=56576cba0bebc50a791ec6e14eb90529&language=en-US',{ 
              headers:Headerss
            }).pipe(
              retry(3), 
              catchError(this.handleError)
  ...
  GetMovieOne(movie_id:number): Observable<IMovieDetails> {
    ...
    return this.http.get<IMovieDetails>(this.apiURL + `movie/${movie_id}?api_key=56576cba0bebc50a791ec6e14eb90529&language=en-U`,{ 
              headers:Headerss
            }).pipe(
              retry(3), 
              catchError(this.handleError)
